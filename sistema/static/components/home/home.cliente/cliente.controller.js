! function (a) {
    ...
    function b(a, c, d, e,f, g){
        ...
        a.clickToOpen = function () {
            var idDialog = g.open({ 
                template: 'views/home/clientes/cliente/modal/clienteModal.html', 
                className: 'alexxxxxx',
        ...
        a.saveCliente = function (data) {
            FD(data);
            
        }
        a.editCliente = function (data) {
            a.clickToOpen();
            a.dataCliente = data;
          
            console.log(a.dataCliente);
        }
   ...
   function d(a) {
    ...
    a.module("view.clientes.controller", [])
    .controller("clientesCtrl", b)
    .controller("ModalCtrl", d)
    d.$inject = []
    b.$inject = ["$scope", "$state", "$storageService", "serviceclientes", "toastr", 'ngDialog']
    // socketio
}(angular)