! function (a) {
    ...
    function b(a, c, d, e,f, g){
        ...
        a.clickToOpen = function () {
            var idDialog = g.open({ 
                template: 'views/home/flota/remolque/modal/remolqueModal.html', 
                className: 'alexxxxxx',
   ...
   function d(a) {
    ...
    a.module("view.remolque.controller", [])
    .controller("remolqueCtrl", b)
    .controller("ModalCtrl", d)
    d.$inject = []
    b.$inject = ["$scope", "$state", "$storageService", "serviceremolque", "toastr", 'ngDialog']
    // socketio
}(angular)