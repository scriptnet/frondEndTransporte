! function (a) {
    ...
    function b(a, c, d, e,f, g){
        ...
        a.clickToOpen = function () {
            var idDialog = g.open({ 
                template: 'views/home/flota/semiremolque/modal/semremolqueModal.html', 
                className: 'alexxxxxx',
        ...
        a.saveRemolque = function (data) {
            FD(data);
            
        }
        a.editRemol = function (data) {
            a.clickToOpen();
            a.dataremol = data;
          
            console.log(a.dataremol);
        }
        ...
        function FD(data){
            a.estado = true;
            data.codigo = a.hash('SEM');
            e.saveRemolque(data).then(function (respuesta) {
   ...
   function d(a) {
    ...
    a.module("view.semiremolque.controller", [])
    .controller("semiremolqueCtrl", b)
    .controller("ModalCtrl", d)
    d.$inject = []
    b.$inject = ["$scope", "$state", "$storageService", "servicesemiremolque", "toastr", 'ngDialog']
    // socketio
}(angular)